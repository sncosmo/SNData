...
+==================+==============+===============+=============================+
| Data Release 1   | DR1          | Spectroscopic | `Folatelli et al. (2013)`_  |
+------------------+--------------+---------------+-----------------------------+
| Data Release 3   | DR3          | Photometric   | `Krisciunas et al. (2017)`_ |
+------------------+--------------+---------------+-----------------------------+
